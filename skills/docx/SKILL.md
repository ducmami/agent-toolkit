---
name: docx
description: "Use when working with Word documents (.docx files) as input or output. Trigger when: user references .docx files, wants to create or edit Word documents, needs tracked changes, comments, tables of contents, or professional formatting. Do NOT trigger for PDFs, spreadsheets, HTML, or general coding tasks."
...
```dot
digraph when_docx {
    "Need Word document?" [shape=diamond];
    "Create from scratch?" [shape=diamond];
    "Use docx-js (Create)" [shape=box];
    "Edit existing?" [shape=diamond];
    "Unpack, Edit XML, Repack" [shape=box];
    "Read/analyze only?" [shape=diamond];
    "Use pandoc or unpack" [shape=box];
    "Use other skill" [shape=box];

    "Need Word document?" -> "Create from scratch?" [label="yes"];
    "Need Word document?" -> "Use other skill" [label="no"];
    "Create from scratch?" -> "Use docx-js (Create)" [label="yes"];
    "Create from scratch?" -> "Edit existing?" [label="no"];
    "Edit existing?" -> "Unpack, Edit XML, Repack" [label="yes"];
    "Edit existing?" -> "Read/analyze only?" [label="no"];
    "Read/analyze only?" -> "Use pandoc or unpack" [label="yes"];
    "Read/analyze only?" -> "Use other skill" [label="no"];
}
```
